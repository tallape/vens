...
LOOKUP_CSV = APP_DIR / 'g2p_vens.csv'
...
# =============================================================================
def load_lookup():
    """Load g2p_vens.csv into dict: {word_lower: (vens_a, vens_b)}"""
    lookup = {}
...
def transform_text(text, mode='a'):
    """
    Replace words with VENS equivalents. mode: 'a'=vens-a, 'b'=vens-b.
    Preserves HTML/MD tags via safe-zone approach.
    """
    idx = 0 if mode == 'a' else 1
...
def convert_epub(filepath, mode, font_path=None):
    ...
    try:
        ...
        mode_name = 'vens-a' if mode == 'a' else 'vens-b'
...
class VENSTransformer:
    ...
    def build_ui(self):
        ...
        rb_a = tk.Radiobutton(mode_frame, text='VENS-A  (Vietnamese diacritics only, no stress marks)',
        ...
        rb_b = tk.Radiobutton(mode_frame, text='VENS-B  (Vietnamese diacritics + stress marks U+0331/U+0333/U+0330)',
